                    ...
                    <inline-form :id="'register-form'" :action="'{{ route('profile.update') }}'"
                        ...
                        <div class="row form-heading-wrapper">
                            <div class="col-lg-10 offset-lg-1">
                                <h4 class="form-heading">{{trans('nk::pages.profile.new_email_heading')}}</h4>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-lg-4 col-form-label text-lg-right">
                                <span>{{trans('nk::pages.profile.new_email_address')}}</span>
                            </label>
                            <div class="col-lg-6 validator-wrapper">
                                ...
                                @else
                                    <small
                                            class="form-text text-muted">{{trans('nk::pages.profile.email_help',['email'=>$user->getAttribute('email')])}}</small>
                                @endif
                            </div>
                        </div>
                        <div class="row form-heading-wrapper">
                            <div class="col-lg-10 offset-lg-1">
                                <h4 class="form-heading">{{trans('nk::pages.profile.notifications_heading')}}</h4>
                            </div>
                        </div>
                        <div class="form-group row">
                            <div class="container">
                                <div class="row">
                                    <div class="col-lg-10 offset-lg-1">
                                        <p class="font-light">{{trans('nk::pages.profile.notifications_help')}}</p>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-lg-6 offset-lg-4">
                                        <div class="custom-control custom-checkbox">
                                            ...
                                            <label class="custom-control-label"
                                                   for="notif-chk-{{$id}}">{{trans(sprintf('nk::general.mailing_lists.%s',$list))}}</label>
                                        </div>
                                    </div>
                                </div>
                                @endforeach
