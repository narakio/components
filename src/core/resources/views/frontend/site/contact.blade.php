    ...
    <div id="user-profile" class="container mt-4">
        <div class="col-md-10 offset-md-1">
            <div class="row justify-content-md-center mt-5">
                <h3 class="font-light mb-3">{{trans('nk::pages.contact.form_title')}}</h3>
            </div>
                ...
                <div class="card-body">
                    <inline-form :id="'register-form'" :action="'{{ route('contact.send') }}'"
                        ...
                        <div class="form-group row">
                            <label class="col-lg-4 col-form-label text-lg-right">{{trans('nk::pages.contact.sender_email')}}</label>
                            <div class="col-lg-6">
                                <input type="email"
                        ...
                        <div class="form-group row">
                            <label class="col-lg-4 col-form-label text-lg-right">{{trans('nk::pages.contact.email_subject')}}</label>
                            <div class="col-lg-6">
                                <input type="text"
                        ...
                        <div class="form-group row">
                            <label class="col-lg-4 col-form-label text-lg-right">{{trans('nk::pages.contact.email_body')}}</label>
                            <div class="col-lg-6">
                                <textarea
                                        class="form-control"
                                        name="email_body"
                        ...
                        <div class="form-group row pt-3">
                            <div class="col-xl-6 offset-xl-4 col-lg-6 offset-lg-4">
                                <submit-button
                                        ref="submitButton"
                                        :block="true"
                                        :value="'{{trans('nk::general.send')}}'"></submit-button>
                            </div>
                        </div>
