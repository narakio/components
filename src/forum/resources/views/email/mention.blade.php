                    ...
                    >
                        ...
                        <tr>
                            ...
                            >
                                ...
                                >
                                    <span style="padding-bottom: 15px">{!! trans('forum::tr.email.mention.title') !!}</span>
                                </div>
                    ...
                    >
                        ...
                        <tr>
                            ...
                            >
                                ...
                                >
                                    {!! trans('forum::tr.email.mention.body1',['user'=>$mention_user,'post'=>$post_title]) !!}
                                </div>
                        ...
                        <tr>
                            ...
                            >
                                ...
                                <div
                                        style="font-family:Lato, Helvetica, Arial, sans-serif;font-size:15px;line-height:1.5;text-align:left;color:#000000;"
                                >
                                    {!! trans('forum::tr.email.mention.body2') !!}
                                </div>
...
<div  style="background:#ce834a;background-color:#ce834a;Margin:0px auto;border-radius:0px 0px 16px 16px;max-width:600px;">

    <table
            align="center" border="0" cellpadding="0" cellspacing="0" role="presentation" style="background:#ce834a;background-color:#ce834a;width:100%;border-radius:0px 0px 16px 16px;"
    >
        <tbody>
        <tr>
            <td
                    style="border-top:8px solid #a75c23;direction:ltr;font-size:0px;padding:20px 0;padding-bottom:22px;padding-left:0px;padding-right:0px;padding-top:25px;text-align:center;vertical-align:top;"
            >
                <!--[if mso | IE]>
                <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                ...
                >
                    ...
                    >
                        ...
                        <tr>
                            <td
                                    align="center" vertical-align="middle" style="font-size:0px;padding:20px 30px;word-break:break-word;"
                            >
